...
$report = Join-Path $backend 'reports\chroma-stage-f-targeted4-furun-citation-relocation-v1-20260901.json'
$envFile = Join-Path $backend '.env'
$attemptId = 'chroma-stage-f-targeted4-furun-citation-relocation-v1-20260901'
$chromaDir = Join-Path $backend '.rag_eval\chroma_repro_26_current_20260831\chroma_data'

$expectedQaGraphSha256 = '0E5709FE7FE2E7C8E75CE4BABED9805C746D6EC3C8E37B07BA73047B6A637FE4'
