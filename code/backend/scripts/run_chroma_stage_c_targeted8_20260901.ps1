...
$report = Join-Path $backend 'reports\chroma-stage-c-targeted8-company-route-v2-20260901.json'
$envFile = Join-Path $backend '.env'
$attemptId = 'chroma-stage-c-targeted8-company-route-v2-20260901'

$expectedQaGraphSha256 = '319E73F348D093D2D1801B1CE88E3FE6D096875EF7D3162550C11A86C5D6FCCC'
