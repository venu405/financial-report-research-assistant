...
$report = Join-Path $backend 'reports\chroma-stage-f-targeted4-furun-citation-relocation-v2-20260901.json'
$envFile = Join-Path $backend '.env'
$attemptId = 'chroma-stage-f-targeted4-furun-citation-relocation-v2-20260901'
